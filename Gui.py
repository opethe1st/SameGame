...
COOL = [(237, 37, 78), (249, 220, 92),
        (244, 255, 253), (1, 25, 54), (70, 83, 98)]

COOL2 = [(73, 88, 103), (87, 115, 153), (189, 213, 234),
         (247, 247, 255), (254, 95, 85)]

COLD = [(25, 83, 95), (11, 122, 117), (215, 201, 170),
        (123, 45, 38), (240, 243, 245)]

ICY = [(216, 219, 226), (169, 188, 208),
       (88, 164, 176), (55, 63, 81), (218, 164, 154)]

SAVANNAH = [(91, 192, 235), (253, 231, 76),
            (155, 197, 61), (229, 89, 52), (250, 121, 33)]
...
class GameDisplay:
    ...
    def _displayScore(self, current):
        pygame.draw.rect(self.screen, GREY, (0, self.GAME_HEIGHT,
                                             self.SCREEN_WIDTH, self.SCOREBOARD_HEIGHT), 0)
        pygame.font.init()
        myfont = pygame.font.Font(
            basedir + os.sep + "Fonts/angrybirds-regular.ttf", 22)
        textsurface = myfont.render(' Score: %s Moves: %s Current move: %s Top Score: %s' % (
            self.board.score, self.board.nmoves, current, self.board.highScore), 1, BLACK, GREY).convert()
    ...
    def _gameOverDisplay(self):
        ...
        pygame.font.init()
        myfont = pygame.font.Font(
            basedir + os.sep + "Fonts/angrybirds-regular.ttf", 72)
        ...
        textsurface = myfont.render('Your Score: %s Top Score: %s ' % (
            self.board.score, self.board.highScore), 1, BLACK, GREY).convert()
    ...
    def _newGame(self):
        ...
        if self.SCREEN_WIDTH * 0.8 < x1 < self.SCREEN_WIDTH * 0.8 + self.SCREEN_WIDTH * 0.15 and self.GAME_HEIGHT + 7 < y1 < self.GAME_HEIGHT + 7 + self.SCOREBOARD_HEIGHT * 0.70:
            ...
            colour = DARKGREY
        pygame.draw.rect(self.screen, BLACK, (self.SCREEN_WIDTH * 0.8, self.GAME_HEIGHT +
